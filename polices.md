...
## Refund Policy for Grapes – 3D Audio Control

At Not a Number GmbH, we are committed to providing high-quality software that meets the needs of our users. To ensure that you can make an informed decision, we offer a **30-day free trial** of Grapes 3D Audio Control. This trial period allows you to evaluate the software in detail before making a purchase.

Please note that due to the nature of digital products, we have implemented a **strict no refund policy**. Once a purchase is made and the software has been delivered, it is considered final. We encourage you to take full advantage of the trial offer to assess the software’s capabilities and determine if it meets your requirements.

If you have any questions or require further information about Grapes 3D Audio Control during your trial, please do not hesitate to contact our support ([support@grapes3d.com](mailto:support@grapes3d.com)).
