# Composing in Ambisonics (DE)

Scrivener-Export aus den deutschen Quelldateien dieses Repositories.

Hinweis: Website-spezifische Navigation, Frontmatter und Shortcodes wurden entfernt oder vereinfacht.
...
Dieser Bereich bündelt die wichtigsten Perspektiven für das Arbeiten in Ambisonics:

- **hören**: wie räumliche Musik analysiert und beschrieben werden kann
- **verorten**: wie sich FOA, HOA, Studios, Konzertorte und Werkzeuge historisch und praktisch einordnen lassen
- **gestalten**: wie Raumparameter, Spatial Counterpoint und Toolchains in reale kompositorische Entscheidungen übersetzt werden

Wenn du neu einsteigst, beginne mit **Overview**, dann mit **Analytisches Hören** und den **10 Fragen im 3D-Raum**. Wenn du bereits produzierst, sind **Spatial Counterpoint** und **Werkzeuge und Software** die schnellsten Einstiege.
...
![Diagramm zu räumlichen Parametern, Distanzzonen und Bewegungsbeziehungen in Composing in Ambisonics](/Users/jschuet1/GitHub/icst-ambisonics.github.io/docs/images/composing_in_ambisonics 1.png)
...
![ICST Kompositionsstudio in Zuerich](/Users/jschuet1/GitHub/icst-ambisonics.github.io/docs/blog/icst-composer-studio-overview/ICST_STUDIO.png)
...
- **Raumparameter als kompositorisches Material**: B-Format, Wahrnehmung und die kompositorische Funktion von Azimut, Elevation, Distanz, Diffusion und Bewegung
- **Vergleich kompositorischer Raumstrategien**: wie unterschiedliche räumliche Organisationsweisen als Formprinzipien wirken
- **Studiopraxis am ICST**: Session-Architektur, Monitoring, B-Format-Archivierung und Multi-Format-Lieferung
...
Bevor man räumliche Trajektorien komponiert, hilft es, sie in den Werken anderer klar zu hören. Dieses Kapitel dient bewusst als **Verweis-Kapitel**: Der eigentliche Hörrahmen wird in den ICST-[ascolta](/blog/ascolta/)-Sessions und im dazugehörigen Listening Guide entfaltet. Dort werden Smalleys Raumkategorien, analytische Hörfragen und Übungen für aktives räumliches Hören systematisch beschrieben.

Für die Lektüre dieses Bereichs ist der Guide die zentrale Ressource:

→ [Ascolta Listening Guide — Analytisches räumliches Hören](/blog/ascolta-listening-guide/)

\newpage

## 3. Geschichte von Ambisonics: FOA und HOA
...
*Interaktive Ambisonics-Zeitleiste im Webartikel; fuer den Scrivener-Export ausgelassen.*
...
### 2.1 Wichtige Institute und Zentren
...
- [Oxford / Michael Gerzon Umfeld](https://intothesoundfield.music.ox.ac.uk/michael-gerzon-story) ist der historische Ausgangspunkt: Hier wurden die Grundlagen von Ambisonics in den 1970er Jahren entscheidend mitgepraegt.
- [IEM Graz](https://ambisonics.iem.at/) ist eines der zentralen Zentren fuer HOA, Ambisonics-Standards, Symposien und die internationale Community rund um immersive Audioforschung.
- [ICST Zuerich](https://www.zhdk.ch/forschung/icst) verbindet Forschung, Komposition und Werkzeuge besonders praxisnah, etwa mit den ICST Ambisonics Tools und Plugins sowie dem Kompositionsstudio.
- [IRCAM Paris](https://support.ircam.fr/docs/spat/3.0/spat-3-intro/co/overview.html) ist wichtig fuer Raumklang, Virtual Acoustics und kuenstlerische Spatialization-Workflows, auch wenn der Fokus breiter ist als nur Ambisonics.
- [ZKM Karlsruhe](https://zkm.de/en/project/sound-dome) ist ein zentraler Ort fuer raeumliche Klangkunst und Auffuehrungspraxis, mit dem Sound Dome und Werkzeugen wie [Zirkonium](https://zkm.de/en/zirkonium).
- [CCRMA Stanford](https://music.stanford.edu/venues-facilities/venues/ccrma-stage) ist ein wichtiger Knoten fuer Forschung, Lehre und kuenstlerische Praxis im Bereich Spatial Audio, einschliesslich Ambisonics-basierter Wiedergabe.
2.2
...
- [ZKM Sound Dome, Karlsruhe](https://zkm.de/en/project/sound-dome) ist einer der wichtigsten Konzertorte fuer raeumliche elektroakustische Musik und immersive Auffuehrungspraxis.
- [IEM CUBE, Graz](https://iem.kug.ac.at/projektseiten/cos/about/further-information/infrastructure) ist ein zentraler Raum fuer HOA-Projektion, Forschung und kuenstlerische Praesentation.
- [ICST Kompositionsstudio, Zuerich](https://ambisonics.ch/blog/icst-composer-studio-overview/) ist weniger klassischer Konzertsaal als Produktions- und Residenzort, aber international relevant fuer Ambisonics-Komposition.
- [IRCAM, Paris](https://medias.ircam.fr/en/media/x0e32bd) ist ein Schluesselort fuer kuenstlerische Spatial-Audio-Praxis; in Produktionen, Seminaren und Tools wie SPAT spielt Ambisonics neben anderen Verfahren eine wichtige Rolle.
- [NOTAM Spatial Audio Studio, Oslo](https://notam.no/en/studio/studio-3/) ist ein wichtiger Produktionsort fuer kuenstlerische Arbeit mit Ambisonics und anderen immersiven Lautsprecherverfahren.
- [EMS Elektronmusikstudion, Stockholm](https://elektronmusikstudion.se/en/about-elektronmusikstudion-ems/) ist seit Jahrzehnten ein zentraler Ort fuer elektroakustische Musik; Ambisonics ist dort Teil eines breiteren Spatial-Audio- und Studio-Kontexts.
- [EMPAC, Troy, New York](https://empac.rpi.edu/2017/spatial-audio-summer-workshop) ist einer der wichtigsten US-amerikanischen Orte fuer grossformatige Spatial-Audio-Praxis mit explizitem HOA- und Ambisonics-Bezug.
- [CCRMA Stage, Stanford](https://music.stanford.edu/venues-facilities/venues/ccrma-stage) ist ein bedeutender US-Ort fuer Forschung, Lehre und kuenstlerische Spatial-Audio-Praxis, auch wenn der Fokus nicht ausschliesslich auf Ambisonics liegt.
- [Tempo Reale, Florenz](https://temporeale.it/en/) ist ein wichtiger italienischer Produktions- und Auffuehrungsort fuer elektroakustische und immersive Musik; der Schwerpunkt liegt breiter auf Spatial Audio und Soundscape-Praxis.
- [Satosphere / SAT, Montreal](https://sat.qc.ca/en/satosphere) ist weltweit praegend fuer immersive kuenstlerische Praxis mit Kuppel-, Spatial-Audio- und performativen Formaten.
- [BEASTdome, Birmingham](https://beast.cal.bham.ac.uk/offspring/beastdome/) ist ein wichtiger Auffuehrungsort fuer elektroakustische und immersive Mehrkanalpraxis.
...
- [Positive Ambisonics, Schottland](https://www.positiveambisonics.org/residencies) ist ein kleiner, spezialisierter Residency- und Studiokontext mit explizitem Ambisonics-Fokus und eigener 8-Kanal-Ambisonics-Umgebung.
- [Dirty Deal Audio Touring Dome, Riga](https://www.dda.lv/touringdome) ist ein mobiles Ambisonics-Setup fuer Konzerte, Listening Sessions, Workshops und pop-up Residencies.
- [Dirty Deal Audio immersive studio](https://www.dda.lv/about) zeigt exemplarisch, wie kleinere unabhaengige Szenen Ambisonics zwischen DIY, Touring und kuenstlerischer Produktion verankern.
- [Sonic Acts Spatial Sound Residency, Rotterdam](https://re-imagine-europe.eu/calendar/spatial-sound-residencies/) ist kein reiner Ambisonics-Ort, aber ein wichtiger kleinerer Produktions- und Residenzrahmen fuer multikanalige und immersive Klangkunst.
- [Live Space / Lithuanian Academy of Music and Theatre](https://www.dda.lv/posts/live-space-2025-vilnius-lithuania) ist ein gutes Beispiel fuer kuenstlerische Workshop- und Konzertformate, in denen mobile Ambisonics-Setups aktiv eingesetzt werden.
2.4
...
- [Nimbus Records](https://www.wyastone.co.uk/nimbus) gehoert zu den wichtigsten historischen Labels fuer Ambisonics und UHJ-Veroeffentlichungen; viele fruehe Referenzaufnahmen wurden ueber Nimbus verbreitet.
- [ICST B-Format Archive](https://ambisonics.ch/blog/b-format-archive/) ist ein wichtiger heutiger Zugang zu kodierten Werken und dokumentiert Ambisonics nicht nur als Technik, sondern auch als Hoerrepertoire.
- [The Michael Gerzon Story](https://intothesoundfield.music.ox.ac.uk/michael-gerzon-story) ist kein Label, aber eine zentrale historische Quelle fuer die fruehe Entwicklungsumgebung, Personen und Produktionszusammenhaenge von Ambisonics.
- [Gerzon Archive](https://audiosignal.co.uk/Gerzon%20archive.html) ist als Dokumentations- und Quellenort wichtig, wenn man die Genealogie von Texten, Ideen und fruehen Ambisonics-Formaten nachvollziehen will.
...
**Ablauf:**
- `0:00-1:00`: Spektrum bleibt fast gleich, aber der Drone wandert von Boden zu Decke, von Ring zu Zentrum, von scharf zu diffus.
- `1:00-2:00`: Raum bleibt fast statisch, dafuer veraendern Filter, Granulation und Rhythmus die Form.
...
**Ablauf:**
- `0:00-0:30`: Ebenen klar trennen
- `0:30-1:00`: Mittelfeld beginnt langsam zu kreisen
- `1:00-1:30`: Vordergrund sinkt in die Textur ein, Fernfeld wird kurz heller und naeher
...
**Ablauf:**
- `0:00-0:30`: 1-2 klar lokalisierte Objekte
- `0:30-1:00`: 3-4 Objekte mit eigener Bahn
- `1:00-1:30`: 6-8 Objekte, teilweise ueberlagert
- `1:30-2:00`: Ruecknahme auf 2 Objekte und breite Restwolke
...
**Ablauf:**
- `0:00-0:20`: Kreisbewegung um den Kopf
- `0:20-0:40`: gerade Fahrt von hinten nach vorne
- `0:40-1:00`: vertikaler Aufstieg
- `1:00-1:30`: mehrere Punkte ziehen ins Zentrum
...
**Ablauf:**
- `0:00-0:20`: trocken, scharf lokalisierbar
- `0:20-0:45`: zunehmender Spread und Decorrelator
- `0:45-1:05`: maximale Wolke
- `1:05-1:30`: Rueckfokussierung auf einen einzelnen Punkt
...
**Ablauf:**
- Version A: starker Einsatz von Overhead und vertikalen Verschiebungen
- Version B: dieselbe Form, aber mit staerkerem Gewicht auf lateralen Bewegungen und klaren Vorder-/Hinterachsen
...
**Ablauf:**
- `0:00-0:45`: subtile Unterschiede, kleine Winkelveraenderungen, feine Hoehenstaffelung
- `0:45-1:30`: dieselbe Idee in groberer, klarerer Form mit staerkeren Kontrasten
...
**Ablauf:**
- `0:00-1:00`: kurze vollstaendige Miniatur mit Anfang, Verdichtung und Schlussgeste
...
- Markiere pro Abschnitt: „R > S/T", „R = S/T" oder „R 8 Objekte)
...
## 5. Die Akustische Gestalt eines Klanges
...
Bevor wir von **Spatial Counterpoint** sprechen, lohnt sich ein kurzer Schritt zur Wahrnehmung selbst: 
**Was macht ein Klangobjekt eigentlich zu einer erkennbaren Gestalt?** 
...
![ICST MultiEncoder mit Radar-GUI und Gruppenbearbeitung](/Users/jschuet1/GitHub/icst-ambisonics.github.io/docs/icst-ambisonics-plugins/06_step_by_step_setup/GP_edit_scaled.png)
...
![Distanzautomation im ICST-Workflow](/Users/jschuet1/GitHub/icst-ambisonics.github.io/docs/icst-ambisonics-plugins/06_step_by_step_setup/Distance.gif)
...
![MultiEncoder mit mehreren Quellen und Gruppenbewegung](/Users/jschuet1/GitHub/icst-ambisonics.github.io/docs/icst-ambisonics-plugins/06_step_by_step_setup/MultiEnc_01.gif)
...
## 7. Raumparameter als kompositorisches Material
...
## 8. Vergleich kompositorischer Raumstrategien
...
- [Organised Sound — Themenausgabe Spatial Music (Cambridge University Press, 2025)](https://www.cambridge.org/core/journals/organised-sound/announcements/call-for-papers/call-perspectives-and-trajectories-in-spatial-music-and-sonic-art)

### Michael Gerzon

- [Gerzon Archiv](https://audiosignal.co.uk/Gerzon%20archive.html)
...
- [Ambisonics 101](/ambisonics-101/) — Signalfluss, HOA-Ordnungen, B-Format-Grundlagen
- [ascolta — alle Hörsessions](/blog/ascolta/) — Werke aus ICST-Residenzen und internationalem Repertoire
- [ICST B-Format Archiv](/blog/b-format-archive/) — kodierte Werke zum Referenzhören
- [Residenzen](/residenzen/) — Dokumentation von Komponist:innen im ICST Studio