...
Akusmatische Musik und die mit ihr verbundene Aufführungspraxis zielt auf eine Situation fokussierten Hörens, indem sie die Mittel der Klangerzeugung im Unsichtbaren hält und visuelle Reize weitgehend ausschaltet. Das ICST verfügt in seinem Archiv über zahlreiche historische Stücke aus dieser Tradition und fördert die Entstehung neuer akusmatischer Werke im Rahmen von künstlerischen Residenzen. Die Konzertreihe _ascolta – Akusmatische Hörstunde_ präsentiert Werke neueren und älteren Datums, die im ICST-Kompositionsstudio (3.D02, Ebene 3, Toni-Areal) jeweils in den (meist mehrkanaligen) Originalversionen gespielt werden. 
![[./_resources/ascolta_'Akusmatische_Hörstunde_am_ICST'.resources/Bildschirmfoto 2022-09-07 um 10.12.34.png]]
...
<<[Table of contents](https://icst-kompositionsstudio.ch/page/table-of-contents)
