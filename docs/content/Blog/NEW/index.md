...
- **Keyboard Shortcuts (Mac):** shift & control 's' / shift & control 'm'
  ![bidi_mute](docs/content/Blog/NEW/bidi_mute.gif)
### **New Layout**
...
- **Additional Features (coming soon)**
  ![New_layout](docs/content/Blog/NEW/Layout_v3_1.png)
...
- 8 different filter options
	![filters](docs/content/Blog/NEW/filters.png)
	
  ![filter UI](docs/content/Blog/NEW/filter_UI.png)
...
![MultiDecoder](docs/content/Blog/NEW/Multidecoder.png)
...
- ICST AmbiPlugins
  ![ICST | 400](docs/content/Blog/NEW/Track_temp_icst.png)
- ICST AmbiPlugins 3rdParty
  ![3rdParty | 400](docs/content/Blog/NEW/Track_temp_3rd.png)
...
![Enc_layout](docs/content/Blog/NEW/Enc_layout.png)
🔹 **Example:** Layout
![Enc_M_S](docs/content/Blog/NEW/Enc_M_S.gif)
