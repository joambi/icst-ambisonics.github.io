...
![GyrOSC](docs/content/post/GYROSC/gyrOSC.png)

The following GIF demonstrates how the ICST AmbiEncoder receives OSC data from the GyrOSC app.

 ![Example video:](docs/content/post/GYROSC/GyroOSC_Demo.gif)
...
2. Configure the app as follows:
 ...
 ![Gyro_01](docs/content/post/GYROSC/Gyro_grav.jpeg)
...
![GyrOSC_Config](docs/content/post/GYROSC/Gyro_Config.jpeg)
...
![Reaper_GyrOSC](docs/content/post/GYROSC/Reaper_GyrOSC.png)
...
![OSC-Swarm](docs/content/post/GYROSC/GyrOSC-SWARM.gif)
