...
| 2. Raum vs. Spektrum/Zeit | 2:00 | 2 | Azimuth, Elevation, Distance vs. Audio-FX | vergleichen, ob Form eher durch Raum oder Klangwandel entsteht |
...
**REAPER-Fokus:** Zeichne im ersten Teil vor allem `Azimuth`, `Elevation`, `Distance` und `Spread`. Im zweiten Teil bleiben diese Werte fast unveraendert, waehrend Audioeffekte die Form uebernehmen.
