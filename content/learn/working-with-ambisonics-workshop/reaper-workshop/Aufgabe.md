...
![REAPER Workflow|697](/static/images/reaper-workflow-diagram.svg)
...
- Use the stereo automation only as a **preview**
- Shape the 3 sources in the **ICST MultiEncoder** or with **ICST MonoEncoders**
- Percussion: clear localisation, circular motion, close
- Drone: move to the back/above, more depth, more diffusion
- Melody: counter-movement against percussion, **2 crossing points**
- Goal: create **spatial counterpoint**, not just a left/right effect

**Be ready to show**
- your spatial idea
- foreground/background
- Your most important musical decision

---
# Ressourcen:

### [Rode](https://rode.com/en-int/apps)
