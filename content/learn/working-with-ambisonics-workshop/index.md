...
Advanced workshop | 4 hours | Prerequisite: basic HOA knowledge  
Tonmeister:innen | Electroacoustic Composers | HOA-Practitioners  
ICST Ambisonics | Zurich University of the Arts | ambisonics.ch

This workshop introduces the complete ICST workflow: planning Ambisonics recordings, A-to-B conversion, B-format production, format audits, live systems, installations, and generative compositional practice.
