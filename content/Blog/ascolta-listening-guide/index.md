---
title: "Active Listening in the Three-Dimensional Sound Field"
description: "A practical listening guide for students and composers working at the ICST Composition Studio."
...
{{< notice info >}}
This guide is a practical listening framework: not only for experiencing spatial music, but for analysing it consciously.
{{< /notice >}}
...
<figure class="big">
  <img src="/images/listening-point-movement-field-en.svg" alt="Diagram of the three fundamental forms of spatial perception: point, movement, and field" loading="lazy" />
  <figcaption><strong>Point, Movement, Field.</strong> Many pieces work not with just one of these forms, but with transitions between precise localisation, trajectory, and diffuse spatial extension.</figcaption>
</figure>

{{< notice info >}}
Spatial critical listening does not only ask: **What sounds?**
But also: **Where, how, and with what effect does it sound in the space?**
{{< /notice >}}
...
<figure class="big">
  <img src="/images/listening-three-levels-en.svg" alt="Diagram of the three levels of active listening: physical, cognitive, and aesthetic-emotional" loading="lazy" />
  <figcaption><strong>Three levels of active listening.</strong> Physical orientation, conceptual analysis, and aesthetic response interlock to produce an analytical listening impression.</figcaption>
</figure>
...
<figure class="big">
  <img src="/images/listening-head-movement-en.svg" alt="Room sketch with listening position, speaker array, and small head movements for better spatial orientation" loading="lazy" />
  <figcaption><strong>Listening position and head movement.</strong> Small, deliberate head movements can help resolve spatial ambiguities — especially when the direction or elevation of a source remains unclear.</figcaption>
</figure>
...
{{< notice warning >}}
Not every spatial ambiguity is a failure of perception. Sometimes the ambiguity itself is part of the compositional intention.
{{< /notice >}}
...
Does the piece create a sense of near and far, or does everything occupy the same perceived distance? Layered distances — a close foreground against a diffuse far background — create a spatial depth analogous to perspective in visual composition.
...
{{< notice update >}}
Do not try to follow all parameters at once. Choose one or two aspects per listening pass and concentrate your attention there.
{{< /notice >}}
...
<figure class="big">
  <img src="/images/listening-note-example-en.svg" alt="Example of a listening note with timeline and annotated spatial events" loading="lazy" />
  <figcaption><strong>From listening to notation.</strong> A simple listening log makes spatial events, transitions, and effects comparable, and supports the second pass.</figcaption>
</figure>
